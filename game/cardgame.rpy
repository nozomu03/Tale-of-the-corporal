        ...
        if len(my_hand.getAll()) > 7:
            ...
            for i in my_hand.getAll():
                imagebutton idle i.img: 
                    action [
                        If(i.number <= 13 and now_card.number <= 13, true = [SetVariable("coreect_card", True), Function(log_print, i.number)], false = Function(log_print1, i.number)),                        
                        If(i.number <= 26 and now_card.number <= 26 and i.number > 13 and now_card.number >13, true = [SetVariable("coreect_card", True), Function(log_print, i.number)], false = Function(log_print1, i.number)),                        
                        If(i.number <= 39 and now_card.number <= 39 and i.number > 26 and now_card.number >26, true = [SetVariable("coreect_card", True), Function(log_print, i.number)], false = Function(log_print1, i.number)),                        
                        If(i.number <= 52 and now_card.number <= 52 and i.number > 39 and now_card.number >39, true = [SetVariable("coreect_card", True), Function(log_print, i.number)], false = Function(log_print1, i.number)),                      
